...
struct ImageAdjustmentView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            adjustRow(icon: "r.circle",      label: "Gamma R",  value: $rGamma, accent: .red).help("Adjust Gamma R")
            adjustRow(icon: "g.circle",      label: "Gamma G",  value: $gGamma, accent: .green).help("Adjust Gamma G")
            adjustRow(icon: "b.circle",      label: "Gamma B",  value: $bGamma, accent: .blue).help("Adjust Gamma B")
            ...
            adjustRow(icon: "r.circle.fill", label: "Gain R",    value: $rGain,  accent: .red).help("Adjust Gain R")
            adjustRow(icon: "g.circle.fill", label: "Gain G",    value: $gGain,  accent: .green).help("Adjust Gain G")
            adjustRow(icon: "b.circle.fill", label: "Gain B",    value: $bGain,  accent: .blue).help("Adjust Gain B")
            ...
            HStack(spacing: 8) {
                ...
                .help("Temporarily disable color adjustments and restore original display")
